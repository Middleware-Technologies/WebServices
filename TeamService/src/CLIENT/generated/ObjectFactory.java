...
public class ObjectFactory {
    ...
    private final static QName _GetTeamResponse_QNAME = new QName("http://service.server/", "getTeamResponse");
    private final static QName _GetTeamsResponse_QNAME = new QName("http://service.server/", "getTeamsResponse");
    private final static QName _GetTeam_QNAME = new QName("http://service.server/", "getTeam");
    private final static QName _GetTeams_QNAME = new QName("http://service.server/", "getTeams");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server/", name = "getTeamResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server/", name = "getTeamsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server/", name = "getTeam")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.server/", name = "getTeams")
